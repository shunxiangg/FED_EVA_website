...
// function checkAuthentication() {
//     const userEmail = localStorage.getItem('userEmail');
//     return !!userEmail; // Returns true if userEmail exists, false otherwise
// }
        ...
        <div class="product-details-grid">
            ...
            <div class="product-info">
                ...
                <div class="specs">
                    ...
                    <p><strong>Available:</strong> ${product.quantity || 0} items</p>
                    ${product.deliveryMethod ? `<p><strong>Delivery:</strong> ${product.deliveryMethod} 
                    ($${product.deliveryMethod === 'express' ? '5.00' : '4.50'})</p>` : ''}
                </div>
                <button onclick="addToCart('${product._id}')" class="add-to-cart-btn">
                    Add to Cart
                </button>
